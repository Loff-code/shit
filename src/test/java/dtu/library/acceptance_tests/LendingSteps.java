...
//		throw new io.cucumber.java.PendingException();
	...
	public void theUserHasToPayAFineOfDKK(Integer int1) {
		// Write code here that turns the phrase above into concrete actions
		assertTrue(this.libraryApp.getFine(this.user,this.date) == int1);
	}
	...
	public void theUserReturnsTheBook() {
		// Write code here that turns the phrase above into concrete actions
		this.user.handInBook(new Book("title", "author", "signature"));
	}
	@Then("the user does not have overdue books")
	public void theUserDoesNotHaveOverdueBooks() {
		// Write code here that turns the phrase above into concrete actions
//		assertFalse(this.user.hasOverdueBooks(this.date));
	}
